    ...
    <section className="py-20 bg-gradient-to-br from-indigo-600 via-indigo-500 to-indigo-700 text-white relative overflow-hidden rounded-3xl mx-4 my-12">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="flex justify-center">
          <Link
            to="/signup"
            className="bg-white text-indigo-600 hover:bg-indigo-50 px-10 py-4 rounded-full font-semibold text-lg shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-xl"
          >
            Sign Up Now
          </Link>
        </div>
